...
108/108 Ridge/LightGBM trials 完成，失败 0。两个全新训练运行的 trial identities、prediction digests 和全部核心指标一致。
...
报告摘要：`sha256:85f2e8b5b39970fc54aea88e75dad9461c571a77f540581fe471f075e5a7f9f0`。

## 裁决

真实宽市场截面标签通过可学习门，Ridge 成为新的 incumbent。LightGBM 虽在 D5/D10 有更高 RankIC，但换手与收益分布没有转化为更高扣费净收益，因此不晋级。D1 收益最高但回撤也最高；D5 当前是收益/回撤更均衡的研究周期；D10 更稳健但收益较低。
