...
- [x] **Step 1: 写 must-not-exist 与 schema 红灯**
...
- [x] **Step 4: 实现 sealed TEST RunManifest identity**
...
- [x] **Step 5: 实现 formal rejection checks**
...
- [x] **Step 6: 实现物理隔离与 repository policy checks**
