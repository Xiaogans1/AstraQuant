...
- [ ] artifact 绑定所有 source/universe/task/feature/code/fold digests；相同输入重复生成逐字节一致。
- [ ] Alpha158 由 pinned Qlib runner 计算，主环境不复制近似公式；提交 `feat(research): 物化Stage B v2截面特征标签`。
