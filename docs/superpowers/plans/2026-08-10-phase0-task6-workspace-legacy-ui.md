...
- [x] **Step 4: 写 integration discovery 红灯并实现 helper**
...
- [x] **Step 6: 实现 launcher discovery**
...
- [x] **Step 4: 同步 TypeScript contract**
...
- [x] 更新 `2026-08-10-quant-core-v3-phase-0-repository-ci-legacy.md` 的 Task 6 checkbox，只勾选已有机器证据支持的步骤。
- [x] 运行 `uv run pytest tests/integration/test_runtime_round_trip.py tests/repository/test_dev_launcher.py tests/api/test_paper_routes.py tests/api/test_model_registry.py -q --basetemp .astraquant/test-tmp/task6-final`。
